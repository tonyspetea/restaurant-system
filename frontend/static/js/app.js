          ...
          <tr class="${u.active?'':'user-inactive'}">
            ...
            <td>
              <div style="display:flex;gap:4px;flex-wrap:wrap">
                <button class="btn btn-ghost btn-sm" onclick="App.openChangePinModal(${u.id},'${u.name}')">Change PIN</button>
                <button class="btn btn-ghost btn-sm" onclick="App.openChangeRoleModal(${u.id},'${u.name}','${u.role}')">Role</button>
